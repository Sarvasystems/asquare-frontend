    ...
    <section className="about-section">
      ...
      <div className="mission-section" ref={missionSectionRef}>
        ...
        <div className="mission-content">
          <p className="mission-text-left">
            ...
            providing exceptional service and expert guidance to clients looking
            to buy, sell, or rent properties. Our goal is to make the real
            estate process as seamless and stress-free as possible. <br />
            <br /> We believe that finding the perfect home or investment should
            be an exciting and rewarding experience. Our team of experienced
            professionals is committed to understanding the unique needs and
          ...
          <p className="mission-text-right">
            ...
            and customer satisfaction are at the core of our business practices.
            We strive to build lasting relationships with our clients, based on
      ...
      <div className="why-choose-section" ref={whyChooseRef}>
        ...
        <p className="why-choose-description">
          Asquared Real Estate is an integrated real estate service provider offering a world-class real estate service to individuals and institutional clients.
          <br /><br />
          Our vision is to be the preferred partner for all your Dubai real estate needs. And the company's mission is to make your investment journey simple, seamless, and satisfying through an integrated approach.
        </p>
