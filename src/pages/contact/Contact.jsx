      ...
      <div className="form-container">
        <div className="form-content">
          <div className="contact-info">
            <h2>Contact us</h2>
            <span>Get in touch with Asquared Real Estate for expert assistance with buying, selling, or renting properties in Dubai. We're here to help. Reach us via phone, email, or our contact form.</span>
          ...
          <form>
            ...
            <div className="form-row">
              <input type="email" placeholder="Email address" className="form-input flex-2" />
              <input type="text" placeholder="Phone number" className="form-input flex-1" />
            </div>
            <div className="form-row">
              <select className="form-select">
            ...
            <div className="form-row">
              <input type="number" placeholder="N. of bedrooms" className="form-input" />
              <input type="number" placeholder="N. of bathrooms" className="form-input" />
              <input type="text" placeholder="Your budget" className="form-input" />
            </div>
